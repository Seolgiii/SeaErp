...
■ 최근 변경 (2026-07-06)
- 앱 아이콘 4종 전면 교체 — 새 남색 물고기 로고로 `app/icon.png`(32·탭)·`public/icons/apple-touch-icon.png`(180)·`icon-192`·`icon-512` 재생성. sharp 흰여백 트림→물고기 프레임 80% 채우도록 재패딩→흰배경 flatten. 크기·RGB 포맷 원본 유지. **미커밋(육안 도그푸딩 대기)**.
